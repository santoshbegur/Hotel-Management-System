...
CREATE TABLE `hotel_staff` (
  ...
  `user_id` bigint NOT NULL,
  PRIMARY KEY (`hotel_id`,`user_id`),
  KEY `FKtk1qdfi66qbsf80d8rjk9waw` (`user_id`),
  CONSTRAINT `FK2t60njrs95kdkec8lfgtlekp4` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`),
  CONSTRAINT `FKtk1qdfi66qbsf80d8rjk9waw` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `hotel_staff` WRITE;
/*!40000 ALTER TABLE `hotel_staff` DISABLE KEYS */;
/*!40000 ALTER TABLE `hotel_staff` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_hotel` (
  ...
  KEY `FKogpiv9er0rcjvdfm9q87l1rf4` (`hotel_id`),
  CONSTRAINT `FKedmkmlua9py8av57k1ajj3ave` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKogpiv9er0rcjvdfm9q87l1rf4` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_role` VALUES (1,1),(21,1),(2,2),(4,2),(9,2),(13,2),(17,2),(8,3),(12,3),(16,3),(20,3),(22,3),(3,4),(5,4),(7,4),(10,4),(11,4),(14,4),(15,4),(18,4),(19,4),(6,5);
...
-- Dump completed on 2025-10-15 15:30:00
