...
INSERT INTO `customer` VALUES (1,'John','Doe','john@example.com','9998887776'),(2,'Alice','Smith','alice@example.com','8887776665');
...
INSERT INTO `hotel` VALUES (1,'Central Grand Hotel','125 Main Street, Bengaluru','+91-9876543212','Asia/Kolkata',NULL),(2,'Sea View Resort','Beach Road, Goa','+91-9123456780','America/New_York',NULL);
...
INSERT INTO `housekeeping_event` VALUES (34,3,'REPORTED','2023-08-12 02:30:00',6),(35,3,'NEEDS_REPAIR','2023-08-12 04:00:00',6),(38,1,'PENDING','2025-09-25 20:29:30',1),(39,3,'PENDING','2025-09-25 21:26:27',5);
...
INSERT INTO `payment` VALUES (1,1,7000.00,'INR','CREDIT_CARD','PAID','TXN123456');
...
INSERT INTO `reservation` VALUES (1,1,1,'CHECKED_OUT','2025-09-20','2025-09-22',7000.00,NULL);
...
INSERT INTO `reservation_line` VALUES (1,1,1,3500.00,2);
...
INSERT INTO `role` VALUES (1,'ADMIN'),(3,'CUSTOMER'),(5,'HOUSEKEEPING'),(2,'MANAGER'),(4,'RECEPTIONIST');
...
INSERT INTO `room` VALUES (1,1,'101',1,1,'BOOKED'),(2,1,'102',2,1,'AVAILABLE'),(3,1,'201',1,2,'OCCUPIED'),(4,2,'301',3,3,'AVAILABLE'),(7,2,'101',3,1,'OCCUPIED');
...
INSERT INTO `room_type` VALUES (1,1,'DLX','Deluxe Room',2,3500.00),(2,1,'STE','Suite',4,6000.00),(3,2,'STD','Standard Room',2,2500.00),(4,2,'FAM','Family Suite',5,7000.00);
...
INSERT INTO `staff` VALUES (1,1,1,1,'2023-05-01'),(2,2,1,2,'2023-06-15'),(3,3,1,3,'2023-07-20'),(4,4,2,2,'2023-08-05'),(5,5,2,3,'2023-08-10'),(6,6,2,4,'2023-09-01'),(16,3,1,4,'2000-05-10'),(17,1,1,1,'2025-09-01'),(18,2,1,2,'2025-01-01');
...
INSERT INTO `user` VALUES (1,'admin_gp','hashed_password1','admin@grandpalace.com'),(2,'manager_gp','hashed_password2','manager@grandpalace.com'),(3,'reception_gp','hashed_password3','reception@grandpalace.com'),(4,'manager_ov','hashed_password4','manager@oceanview.com'),(5,'reception_ov','hashed_password5','reception@oceanview.com'),(6,'housekeeping_ov','hashed_password6','housekeeping@oceanview.com');
...
-- Dump completed on 2025-09-26 10:05:44
